/**
    ...
    Other：
         1.点灯科技(blinker)文档：https://diandeng.tech/doc/getting-start-8266
...
BGWiFiConfig wifipw;
#define key D3   //按钮清除配网信息，其他esp8266/32开发板改这个中断io口即可。
...
String htmlret = String("<html><head><meta charset=\"utf-8\"></head><body>配置成功，请重启开发板并打开blinker软件，等待开发板连接WiFi。</body></html>");
